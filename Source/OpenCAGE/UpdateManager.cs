    ...
    static class UpdateManager
    {
        ...
        static public bool IsUpdateAvailable(string ProductVersion)
        {
            ...
            try
            {
                ...
                Stream webStream = webClient.OpenRead("https://raw.githubusercontent.com/MattFiler/OpenCAGE/" + branch_name + "/Source/OpenCAGE/Properties/AssemblyInfo.cs?v=" + ProductVersion + "&r = " + random.Next(5000).ToString());
