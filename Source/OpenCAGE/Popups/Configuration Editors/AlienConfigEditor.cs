...
namespace OpenCAGE.ConfigEditors
{
    public partial class AlienConfigEditor : BaseWindow
    {
        ...
        private void Save(object sender, EventArgs e)
        {
            ...
            if (decrease_sweep_duration.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "decrease_sweep_duration").InnerText = decrease_sweep_duration.Text;
            if (increase_sweep_duration.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "increase_sweep_duration").InnerText = increase_sweep_duration.Text;
            if (near_target_exclusion_radius_first_stalk_min.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "near_target_exclusion_radius_first_stalk_min").InnerText = near_target_exclusion_radius_first_stalk_min.Text;
            if (near_target_exclusion_radius_first_stalk_max.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "near_target_exclusion_radius_first_stalk_max").InnerText = near_target_exclusion_radius_first_stalk_max.Text;
            if (near_target_exclusion_radius_subsequent_stalk_min.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "near_target_exclusion_radius_subsequent_stalk_min").InnerText = near_target_exclusion_radius_subsequent_stalk_min.Text;
            if (near_target_exclusion_radius_subsequent_stalk_max.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "near_target_exclusion_radius_subsequent_stalk_max").InnerText = near_target_exclusion_radius_subsequent_stalk_max.Text;
            if (near_objective_exclusion_radius_first_stalk_min.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "near_objective_exclusion_radius_first_stalk_min").InnerText = near_objective_exclusion_radius_first_stalk_min.Text;
            if (near_objective_exclusion_radius_first_stalk_max.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "near_objective_exclusion_radius_first_stalk_max").InnerText = near_objective_exclusion_radius_first_stalk_max.Text;
            if (near_objective_exclusion_radius_subsequent_stalk_min.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "near_objective_exclusion_radius_subsequent_stalk_min").InnerText = near_objective_exclusion_radius_subsequent_stalk_min.Text;
            if (near_objective_exclusion_radius_subsequent_stalk_max.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "near_objective_exclusion_radius_subsequent_stalk_max").InnerText = near_objective_exclusion_radius_subsequent_stalk_max.Text;
            if (menace_gauge_decrease_time.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "menace_gauge_decrease_time").InnerText = menace_gauge_decrease_time.Text;
            if (meance_deemed_time.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "meance_deemed_time").InnerText = meance_deemed_time.Text;
            if (max_menaces.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "max_menaces").InnerText = max_menaces.Text;
            if (menace_gauge_seconds_to_fill.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "menace_gauge_seconds_to_fill").InnerText = menace_gauge_seconds_to_fill.Text;
            if (sweep_box_half_width.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "sweep_box_half_width").InnerText = sweep_box_half_width.Text;
            if (sweep_box_min_half_length.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "sweep_box_min_half_length").InnerText = sweep_box_min_half_length.Text;
            if (Vent_Attract_Time_Min.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "Vent_Attract_Time_Min").InnerText = Vent_Attract_Time_Min.Text;
            if (Vent_Attract_Time_Max.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "AreaSweep", "Vent_Attract_Time_Max").InnerText = Vent_Attract_Time_Max.Text;

            if (role_timeout_min.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "BackstageAreaSweep", "role_timeout_min").InnerText = role_timeout_min.Text;
            if (role_timeout_max.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "BackstageAreaSweep", "role_timeout_max").InnerText = role_timeout_max.Text;
            if (min_distance.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "BackstageAreaSweep", "min_distance").InnerText = min_distance.Text;
            if (max_distance.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "BackstageAreaSweep", "max_distance").InnerText = max_distance.Text;
            if (min_idle_time.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "BackstageAreaSweep", "min_idle_time").InnerText = min_idle_time.Text;
            if (max_idle_time.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "BackstageAreaSweep", "max_idle_time").InnerText = max_idle_time.Text;
            if (killtrap_time.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "BackstageAreaSweep", "killtrap_time").InnerText = killtrap_time.Text;
            if (ambush_timeout.Enabled) ConfigEditorUtils.EnsureChildElements(doc, "AlienConfig", "BackstageAreaSweep", "ambush_timeout").InnerText = ambush_timeout.Text;
